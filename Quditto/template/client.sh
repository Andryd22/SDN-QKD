...
response_AB=$(wget -qO - "http://IP_NODO_A:8000/api/v1/keys/B/enc_keys?size=512")
...
response_BA=$(wget -qO - "http://IP_NODO_B:8000/api/v1/keys/A/dec_keys?key_ID=${key_id_AB}")
...
response_B=$(wget -qO - "http://IP_NODO_B:8000/api/v1/keys/A/dec_keys?key_ID=628459b2-0454-49e2-a208-f1c7484e7c29")
